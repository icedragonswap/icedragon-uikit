...
var getButtonVariantProp = function (prop) { return function (_a) {
    var theme = _a.theme, _b = _a.variant, variant = _b === void 0 ? variants.SUBTLE : _b;
...
var UserBlock = function (_a) {
    ...
    return (React__default['default'].createElement("div", null, account ? (React__default['default'].createElement(Button, { size: "sm", variant: "tertiary", onClick: function () {
        ...
        } }, accountEllipsis)) : (React__default['default'].createElement(Button, { size: "sm", variant: "subtle", onClick: function () {
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#452A7A", textDisabled: "#BDC2C4", textSubtle: "#0d1f38", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#3e3718", background: "#10242b", backgroundDisabled: "#333a3e", contrast: "#bdcae4", invertedContrast: "#133054d9", input: "#133054d9", primaryDark: "##0d0e0e", tertiary: "#0f2121", text: "#f1d7a3", textDisabled: "#666171", textSubtle: "#ced8ef", borderColor: "#524B63", card: "#164688d4", gradients: {
